...
echo " ../configure --prefix=/home/user/dev/deliveries/stdair-0.29.0 --srcdir=.." && \
echo "" && \
echo "Alternatively" && \
echo "mkdir build && cd build && cmake -DCMAKE_INSTALL_PREFIX=/home/user/dev/deliveries/stdair-0.29.0 .."
echo "" && \
exit 0
