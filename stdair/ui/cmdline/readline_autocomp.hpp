 ...
 */
#ifndef __AIRINV_READLINE_AUTOCOMP_HPP
#define __AIRINV_READLINE_AUTOCOMP_HPP
...
int execute_line (char* line) {
  ...
  if (!command) {
    std::cerr << word << ": No such command for airinv." << std::endl;
    return -1;
  }
...
#endif // _AIRINV_READLINE_AUTOCOMP_HPP
