#ifndef __STDAIR_BOM_POLICYKEY_HPP
#define __STDAIR_BOM_POLICYKEY_HPP
...
namespace stdair {
   ...
   */
  struct PolicyKey : public KeyAbstract {
  ...
  private:
     ...
     * Policy code.
     */
    PolicyCode_T _policyCode;
  };

}
#endif // __STDAIR_BOM_POLICYKEY_HPP
