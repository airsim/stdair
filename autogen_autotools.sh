...
echo " ../configure --prefix=/home/user/dev/deliveries/stdair-0.39.2 --srcdir=.." && \
echo "" && \
echo "Alternatively" && \
echo "mkdir build && cd build && cmake -DCMAKE_INSTALL_PREFIX=/home/user/dev/deliveries/stdair-0.39.2 \\" \
